public class VariableNamesTheme {
    public static void main(String[] args) {
        ...
        System.out.println("Количество чисел в каждой строке: " + amountOfNumbers);
        ...
        System.out.println("Компьютер включён? " + isComputerTurnedOn);
